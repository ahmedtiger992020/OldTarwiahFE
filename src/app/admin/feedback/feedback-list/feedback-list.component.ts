...
export class FeedbackListComponent {
  ...
  searchCriteria: FeedbackSearchCriteria = new FeedbackSearchCriteria(this.filters, this.sortModel, '');
  ...
  searchData(){
    this.feedbackService.getFeedbackQuestions(this.searchCriteria).subscribe({
      next: (result) => 
        {
          if(!result.isSucess){
