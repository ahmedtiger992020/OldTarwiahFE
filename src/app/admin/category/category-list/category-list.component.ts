import { Component, Input, OnChanges, OnDestroy, OnInit, SimpleChanges, TemplateRef, input } from '@angular/core';
...
export class CategoryListComponent implements OnInit {
  ...
  searchCriteria: CategorySearchCriteria = new CategorySearchCriteria(this.filters, this.sortModel, '');
  ...
  onUpload() {
    ...
    this.categoryService.importFile(formData).subscribe({
      next: (result) => 
      {
        if(!result.isSucess){
