...
@Component({
  selector: 'app-coulmn-chart',
  templateUrl: './coulmn-chart.component.html',
  styleUrls: ['./coulmn-chart.component.css']
})
export class CoulmnChartComponent implements OnInit{
 ...
 if (this.salesChart) {
  ...
  const ctx = document.getElementById(this.Id);
    ...
    this.salesChart = new Chart(this.Id, {
      type: "bar",
      data: {
        labels: this.Labels,
